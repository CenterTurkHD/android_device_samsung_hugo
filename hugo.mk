...
PRODUCT_COPY_FILES += \
	...
	device/samsung/hugo/init.latona.rc:root/init.latona.rc \
	...
	device/samsung/hugo/ueventd.latona.rc:root/ueventd.latona.rc \
	device/samsung/hugo/ueventd.rc:recovery/root/ueventd.rc \
	device/samsung/hugo/ueventd.latona.rc:recovery/root/ueventd.latona.rc
...
# librotation.so file
PRODUCT_COPY_FILES += \
    device/samsung/hugo/prebuilt/librotation.so:system/lib/librotation.so
...
DEVICE_PACKAGE_OVERLAYS += device/samsung/hugo/overlay
...
PRODUCT_COPY_FILES += \
	device/samsung/hugo/updater.sh:updater.sh

# See comment at the top of this file. This is where the other
# half of the device-specific product definition file takes care
# of the aspects that require proprietary drivers that aren't
# commonly available
$(call inherit-product-if-exists, vendor/samsung/hugo/hugo-vendor.mk)
